...
//                                 centroidPoint.y,
//                                 centroidPoint.z);
    pcl::PointXYZ centroidVector(centroidPoint.x,
                                 centroidPoint.y,
                                 centroidPoint.z);
...
//    Eigen::Vector3f thisVector(thisPoint.x, thisPoint.y, thisPoint.z);
    pcl::PointXYZ thisVector(thisPoint.x, thisPoint.y, thisPoint.z);
    float pointCentroidDistance = pcl::geometry::distance(thisVector, 
      centroidVector);
    float pointGraspPlaneDistance = graspHyperplane.absDistance(thisVector.getVector3fMap());
...
//                                      secondInitialPoint.z);
    pcl::PointXYZ firstInitialVector(firstInitialPoint.x,
                                       firstInitialPoint.y,
                                       firstInitialPoint.z);
    pcl::PointXYZ secondInitialVector(secondInitialPoint.x,
                                        secondInitialPoint.y,
                                        secondInitialPoint.z);
...
//    Eigen::Vector3f firstVector(firstPoint.x, firstPoint.y, firstPoint.z);
    pcl::PointXYZ firstVector(firstPoint.x, firstPoint.y, firstPoint.z);
    ...
    Eigen::Vector3f firstNormalVector(firstPoint.normal_x,
                                      firstPoint.normal_y,
                                      firstPoint.normal_z);
    float firstPointGraspPlaneDistance = graspHyperplane.absDistance(firstVector.getVector3fMap());
...
//      Eigen::Vector3f secondVector(secondPoint.x, secondPoint.y, secondPoint.z);
      pcl::PointXYZ secondVector(secondPoint.x, secondPoint.y, secondPoint.z);
      ...
      float secondPointGraspPlaneDistance = graspHyperplane.absDistance(
        secondVector.getVector3fMap());
      float secondPointCurvature = secondPoint.curvature;

      Eigen::Vector3f graspDirectionVector = 
        Eigen::ParametrizedLine<float,3>::Through(firstVector.getVector3fMap(), secondVector.getVector3fMap()).direction();
